...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 23 Okt 2023 pada 02.33
...
INSERT INTO `user` (`id_pegawai`, `username`, `password`, `nama_pegawai`, `alamat_pegawai`, `hp_pegawai`, `id_bagian`) VALUES
...
CREATE TABLE `users` (
  ...
  `hp_pegawai` varchar(255) DEFAULT NULL,
...
INSERT INTO `users` (`id`, `username`, `authKey`, `password`, `accessToken`, `nama_pegawai`, `alamat_pegawai`, `hp_pegawai`, `id_bagian`) VALUES
(1, 'admin', '', 'admin', '', 'Admin', '-', '-', 7),
(2, 'manager', NULL, 'manager', NULL, 'manager', 'manager', '0', 8),
(3, 'gudang', NULL, 'gudang', NULL, 'gudang', 'gudang', '0', 9),
(4, 'pesanan', NULL, 'pesanan', NULL, 'pesanan', 'pesanan', '0', 10),
(5, 'produksi', NULL, 'produksi', NULL, 'produksi', 'produksi', '0', 11);
...
--
ALTER TABLE `barang`
  MODIFY `id_barang` int(16) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=137;

--
-- AUTO_INCREMENT untuk tabel `pemesanan`
--
ALTER TABLE `pemesanan`
  MODIFY `id_pesanan` int(16) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=99;

--
-- AUTO_INCREMENT untuk tabel `pengambilan`
--
ALTER TABLE `pengambilan`
  MODIFY `id_pengambilan` int(16) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT untuk tabel `produksi`
--
ALTER TABLE `produksi`
  MODIFY `id_produksi` int(16) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=116;

--
-- AUTO_INCREMENT untuk tabel `user`
--
ALTER TABLE `user`
  MODIFY `id_pegawai` int(16) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
