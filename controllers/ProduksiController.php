...
class ProduksiController extends Controller
{
    ...
    public function actionPesanan(){
        ...
        ->select([
            'pemesanan.id_pesanan', 'pemesanan.nama_pemesan', 'pemesanan.proses',
            'barang.nama_barang', 'pemesanan.jumlah_pesanan'
            ])
        ->from('barang')
        ->innerJoin('pemesanan', 'pemesanan.id_barang = barang.id_barang')
        ->orderBy('pemesanan.id_pesanan');

        $dataProvider = new ActiveDataProvider([
            'query' => $query,
        ]);

        return $this->render('pesanan', [
            'dataProvider' => $dataProvider,
        ]);
    }
